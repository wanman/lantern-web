...
// Copyright (c) 2018 Scott Ferguson
// https://github.com/200even/geohash-distance
Geohash.inKm = function (firstHash, secondHash) {
  var loc1 = Geohash.decode(firstHash);
  var loc2 = Geohash.decode(secondHash);
  return distanceBetweenCoordinates(loc1, loc2, 6371)
};

Geohash.inMiles = function (firstHash, secondHash) {
  var loc1 = Geohash.decode(firstHash);
  var loc2 = Geohash.decode(secondHash);
